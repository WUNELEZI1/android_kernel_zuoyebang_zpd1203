...
#define TP_EARPHONE_PLUGIN   1
#ifdef TP_EARPHONE_PLUGIN
#include "../lct_tp/lct_tp_earphone.h"
#endif

#define OVT_PM_WAIT_BUS_RESUME_COMPLETE    1

#define LCT_TP_DATA_DUMP  1
#if LCT_TP_DATA_DUMP
#define TP_DATA_DUMP "tp_data_dump"
extern int lct_tp_data_dump_proc_init(void);
extern void lct_tp_data_dump_proc_exit(void);
#endif
...
#define HDL_WR_CHUNK_SIZE 0 /* For HDL command 45, 0 = unlimited ,1025, 2049, 4097, 8193*/
...
#define LOGx(func, dev, log, ...) \
	func(dev, "%s info %d: " log, __func__, __LINE__, ##__VA_ARGS__)

#define LOGy(func, dev, log, ...) \
	func(dev, "%s error %d: " log, __func__, __LINE__, ##__VA_ARGS__)
...
struct ovt_tcm_hcd {
	...
	unsigned int image_packrat_number;
#endif
