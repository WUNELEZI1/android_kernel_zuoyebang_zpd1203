 ...
 *
 ****************************************************************************/
#ifndef __SC1320CS_TRULY_MAIN_I_MIPI_RAW_H
#define __SC1320CS_TRULY_MAIN_I_MIPI_RAW_H
...
struct imgsensor_info_struct {
	kal_uint16 sensor_id;		/* define in kd_imgsensor.h */
