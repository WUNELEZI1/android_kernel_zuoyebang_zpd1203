...
#include "imx852_ofilm_main_ii_mipi_raw_Sensor.h"
#include "imx852_ofilm_main_ii_mipi_raw_setting.h"
...
#define PFX "IMX852_ofilm_main_ii_camera_sensor"
/****************************   Modify end	**************************/
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = IMX852_OFILM_MAIN_II_SENSOR_ID,
...
static void imx852_ofilm_fusion_id_read(void)
{
	...
	LOG_INF("%s %d zengx fusion_id_main[%d]=0x%2x\n",__func__, __LINE__, i, fusion_id_main[i]);
	}
}
static void imx852_ofilm_sn_id_read(void)
{
	...
	for (i=0; i<25; i++) {
		...
		LOG_INF("%s %d zengx sn_main[%d]=0x%2x\n",__func__, __LINE__, i, sn_main[i]);
	}
}
#endif
...
UINT32 IMX852_OFILM_MAIN_II_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
	/* To Do : Check Sensor status here */
	if (pfFunc != NULL)
		*pfFunc = &sensor_func;
	return ERROR_NONE;
} /* IMX852_OFILM_MAIN_II_MIPI_RAW_SensorInit */
