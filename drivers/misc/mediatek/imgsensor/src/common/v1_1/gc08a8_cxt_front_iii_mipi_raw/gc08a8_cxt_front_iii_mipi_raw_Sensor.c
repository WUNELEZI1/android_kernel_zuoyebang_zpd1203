...
#include "gc08a8_cxt_front_iii_mipi_raw_Sensor.h"
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = GC08A8_CXT_FRONT_III_SENSOR_ID,
...
/*system*/
	...
	0x0337, 0x04,
	0x0335, 0x51,
	0x0336, 0x73, //0x0336, 0x70,
	0x0383, 0xbb,
	0x031a, 0x00,
	0x0321, 0x10,
	0x0327, 0x03,
	0x0325, 0x40,
	0x0326, 0x23, //0x0326, 0x23,
	0x0314, 0x11,
	0x0315, 0xd6,
	0x0316, 0x01,
	0x0334, 0x40,
...
/*system*/
	...
	0x0337, 0x04,
	0x0335, 0x51,
	0x0336, 0x73, //stephen 0x0336, 0x72,
	0x0383, 0xbb,
	0x031a, 0x00,
	0x0321, 0x10,
	0x0327, 0x03,
	0x0325, 0x40,
	0x0326, 0x23, //0x0326, 0x25, 
	0x0314, 0x11,
	0x0315, 0xd6,
	0x0316, 0x01,
	0x0334, 0x40,
...
static kal_uint16 gc08a8_3264x1836_addr_data[] = {
	0x031c, 0x60,
	0x0337, 0x04,
	0x0335, 0x51,
	0x0336, 0x73, //0x0336, 0x71, 
	0x0383, 0xbb,
	0x031a, 0x00,
	0x0321, 0x10,
	0x0327, 0x03,
...
static void normal_video_setting(kal_uint16 currefps)
{
	...
	table_write_cmos_sensor(gc08a8_3264x1836_addr_data,
		sizeof(gc08a8_3264x1836_addr_data)/sizeof(kal_uint16));
...
#if 1
static kal_uint16 read_cmos_sensor_gc08a8_cxt_otp(kal_uint32 addr)
{
	kal_uint16 get_byte = 0;
...
static void gc08a8_fusion_id_read(void)
{
	int i;
	for (i=0; i<12; i++) {
		fusion_id_front[i] = read_cmos_sensor_gc08a8_cxt_otp(0x10+i);
	pr_debug("%s %d lss fusion_id_front[%d]=0x%2x\n",__func__, __LINE__, i, fusion_id_front[i]);
	}
}
static void gc08a8_sn_id_read(void)
{
	int i;
	for (i=0; i<25; i++) {
	        sn_front[i] = read_cmos_sensor_gc08a8_cxt_otp(0x0EDC+i);
