...
/*
 * CN3968AF voice coil motor driver
 *
 *
 */
...
#define AF_DRVNAME "CN3968AF_DRV"
...
static int s4CN3968AF_ReadReg(unsigned short *a_pu2Result)
{
...
static inline int moveAF(unsigned long a_u4Position)
{
	...
	if (*g_pAF_Opened == 1) {
		...
		initdrv();
		ret = s4CN3968AF_ReadReg(&InitPos);
...
/* ////////////////////////////////////////////////////////////// */
long CN3968AF_Ioctl_Main(struct file *a_pstFile,
...
int CN3968AF_Release_Main(struct inode *a_pstInode, struct file *a_pstFile)
{
	LOG_INF("Start\n");
...
int CN3968AF_SetI2Cclient_Main(struct i2c_client *pstAF_I2Cclient,
...
int CN3968AF_GetFileName_Main(unsigned char *pFileName)
{
