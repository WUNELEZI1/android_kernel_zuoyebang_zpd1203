...
#define CHGR_FLOAT_MAX_VOLTAGE_CFG_REG		(CHGR_BASE + 0x76)
#define CHGR_FLOAT_MAX_VOLTAGE_CFG_MASK		GENMASK(7, 0)
...
#define DCDC_VBOOST_REG			(DCDC_BASE + 0x86)
#define DCDC_VBOOST_MASK		GENMASK(2, 0)
#define DCDC_VBOOST_5V			0x02
#define DCDC_VBOOST_5p5V		0x07
...
enum {
	FLOAT_MAX_VLOT_4P53_V = 0x5D,
	FLOAT_MAX_VLOT_4P56_V = 0x60,
	FLOAT_MAX_VLOT_4P60_V = 0x64,
	FLOAT_MAX_VLOT_4P75_V = 0x73,
	FLOAT_MAX_VLOT_4P78_V = 0x76
};
...
#define SCHG_P_USB_USBIN_ADAPTER_ALLOW_CFG			(USBIN_BASE + 0x60)
#define SCHG_P_USB_USBIN_ADAPTER_ALLOW_5V_12V		0x0c
