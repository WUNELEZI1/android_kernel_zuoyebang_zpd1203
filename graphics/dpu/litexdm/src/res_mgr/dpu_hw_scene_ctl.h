...
struct dpu_hw_scene_ctl_ops {
	 ...
	 */
	void (*rch_mount)(struct dpu_hw_blk *hw, uint32_t rch_mask);
	 ...
	 */
	void (*wb_mount)(struct dpu_hw_blk *hw, uint32_t wb_mask);
	 ...
	 */
	void (*timing_engine_mount)(struct dpu_hw_blk *hw, uint32_t tmg_mask);
