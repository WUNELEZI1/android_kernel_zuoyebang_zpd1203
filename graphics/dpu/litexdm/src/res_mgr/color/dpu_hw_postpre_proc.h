...
struct dpu_hw_postpre_proc_ops {
	/**
	 * enable - enable or disable the post pre process module
	 * currently contain: eotf, mul_matrix, oetf
	 * @hw: the post_pre_proc hardware pointer
	 * @ctrl: postpq feature contrl info
	 */
	void (*feature_enable)(struct dpu_hw_blk *hw, struct postpq_feature_ctrl *ctrl);
