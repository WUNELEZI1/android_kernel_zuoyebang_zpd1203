...
#ifndef _DPU_HW_POST_3DLUT_H_
#define _DPU_HW_POST_3DLUT_H_
...
/**
 * dpu_hw_post_3dlut_ops - the external interface of post 3dlut
 */
struct dpu_hw_post_3dlut_ops {
	/**
	 * enable - enable or disable the post 3dlut module
	 * @hw: the post_3dlut hardware pointer
	 ...
	 * @hw: the post_3dlut hardware pointer
	 * @use_cpu: use or not cpu to cfg reg
	 */
...
/**
 * dpu_hw_post_3dlut - post 3dlut hardware object
 * @hw: the post 3dlut hardware info
 * @blk_cap: the post 3dlut hardware resource and capability
 * @ops: the post 3dlut function table
 */
struct dpu_hw_post_3dlut {
	struct dpu_hw_blk hw;
	const struct dpu_post_3dlut_cap *blk_cap;

	struct dpu_hw_post_3dlut_ops ops;
};

static inline struct dpu_hw_post_3dlut *
	to_dpu_hw_post_3dlut(struct dpu_hw_blk *hw)
{
	return container_of(hw, struct dpu_hw_post_3dlut, hw);
}

/**
 * dpu_hw_post_3dlut_init - init post 3dlut hw block with its capability
...
/**
 * dpu_hw_post_3dlut_deinit - deinit post 3dlut hw block with base hw block pointer
 * @hw: base hw block pointer
 */
void dpu_hw_post_3dlut_deinit(struct dpu_hw_blk *hw);

#endif /* _DPU_HW_POST_3DLUT_H_ */
