...
#define STRTAB_STE_1_PRIVCFG_UNPRIVILEGED	2UL
...
#define ARM_SMMU_MAX_VMIDS		(1 << 16)
	...
	struct arm_smmu_reg_context	context;
	atomic_t			tcu_link_cnt;
	spinlock_t			tcu_lock;
	struct regulator		*master_rg;
	bool				bypass;
	...
	u32				cell_size;
	DECLARE_BITMAP(ssid_bitmap, 1 << MAXCONTEXT);
#endif
};
