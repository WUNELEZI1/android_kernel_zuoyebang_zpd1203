...
/*
 * Send MITEE Message Buffer Config
 *
 * Call register usage:
 * w3:		Service ID, OPTEE_FFA_SET_MITEE_MSG_BUFFER
 * w4:		Message buffer paddr
 * 			paddr should be page aligned.
 * w5:		Message buffer size
 * 			size should be equivalent to an odd number of physical pages
 * w6-w7:	Preserved
 *
 * Return register usage:
 * w3-w7:	Preserved
 */
#define OPTEE_FFA_SET_MITEE_MSG_BUFFER OPTEE_FFA_BLOCKING_CALL(12)
