...
static int __optee_enumerate_devices(u32 func)
{
	const uuid_t pta_uuid =
		UUID_INIT(0x7011a688, 0xddde, 0x4053, 0xa5, 0xa9, 0x7b, 0x3c,
			  0x4d, 0xdf, 0x13, 0xb8);
	...
	device_shm =
		tee_shm_alloc(ctx, shm_size, TEE_SHM_MAPPED | TEE_SHM_DMA_BUF);
...
{
	bus_for_each_dev(&tee_bus_type, NULL, NULL, __optee_unregister_device);
}
