...
TRACE_EVENT(tracing_mark_write,
	...
	TP_printk("%c|%d|Read Thp Frame (frm_cnt:%d, frame_no:%d)", __entry->trace_type,
			__entry->pid, __entry->thp_cnt, __entry->ic_frame_no)
)
#define TOUCH_TRACE_FRAME_CNT_BEGIN(thp_cnt, ic_frame_no) trace_tracing_mark_write('B', current, thp_cnt, ic_frame_no)
#define TOUCH_TRACE_FRAME_CNT_END() trace_tracing_mark_write('E', current, 0, 0)

#endif /* _TRACE_H_ */
#undef TRACE_INCLUDE_PATH
#define TRACE_INCLUDE_PATH ../../../../vendor/xiaomi/proprietary/touch/touchfeature_v2/touch_driver/m2/fts_spi/
