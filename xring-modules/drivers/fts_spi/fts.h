...
/**** CODE CONFIGURATION ****/
#define FTS_TS_DRV_NAME                     "st,spi"			/*driver name*/
...
#define PINCTRL_STATE_ACTIVE_NEW	"pmx_ts_active_new"
#define PINCTRL_STATE_SUSPEND_NEW	"pmx_ts_suspend_new"
...
struct fts_ts_info {
	...
	struct pinctrl_state *pinctrl_state_secure;
