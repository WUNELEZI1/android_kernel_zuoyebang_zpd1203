...
/**
 * enum kbase_queue_group_throttle - Kbase internal relative throttle list.
 * @KBASE_QUEUE_GROUP_THROTTLE_NONE:                  no throttle, this means that it is a vulkan queue or opengl context.
 * @KBASE_QUEUE_GROUP_THROTTLE_HIGH:                  The high queue group throttle.
 * @KBASE_QUEUE_GROUP_THROTTLE_MEDIUM:                The medium queue group throttle.
 * @KBASE_QUEUE_GROUP_THROTTLE_LOW:                   The low queue group throttle.
 * @KBASE_QUEUE_GROUP_THROTTLE_NO_BOOST:              no boost needed for an opencl app.
 * @KBASE_QUEUE_GROUP_THROTTLE_COUNT:                 The number of throttle levels.
 */
enum kbase_queue_group_throttle {
	KBASE_QUEUE_GROUP_THROTTLE_NONE = 0,
	...
	KBASE_QUEUE_GROUP_THROTTLE_COUNT
};
 ...
 * @throttle:       Throttle of the queue group, 0 being the highest,
 *                  BASE_QUEUE_GROUP_THROTTLE_COUNT - 1 being the lowest.
...
#define ITER_TILER_ACTIVE_IDX (64)
#define ITER_COMP_ACTIVE_IDX  (32)
#define ITER_FRAG_ACTIVE_IDX (48)
#endif
...
#if IS_ENABLED(CONFIG_MALI_XR_GPU_PROTECTED_MEMORY)
	struct dma_heap *protected_heap;
#endif
};
