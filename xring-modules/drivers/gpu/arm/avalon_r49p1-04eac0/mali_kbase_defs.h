 ...
 * @proc_buf_node:      Indicate the dmabuf node used in the process, used for pss
 *                      EGL calculation
 */
struct kbase_process {
	...
	struct kbase_dma_buf *proc_buf_node;
};
 ...
 * @dev_buf_node:          Indicate a dmabuf node used in the device, used for pss
 *                         EGL calculation
...
struct kbase_device {
	...
	struct kbase_dma_buf *dev_buf_node;
