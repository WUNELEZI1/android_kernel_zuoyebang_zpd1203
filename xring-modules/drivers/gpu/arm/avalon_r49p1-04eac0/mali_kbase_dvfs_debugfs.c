...
static int kbasep_dvfs_utilization_debugfs_show(struct seq_file *file, void *data)
{
	...
	seq_printf(file, "tiler_busy_time: %u tiler_idle_time: %u\n",
		   kbdev->pm.backend.metrics.values.time_busy[1],
		   kbdev->pm.backend.metrics.values.time_idle[1]);
	seq_printf(file, "compute_busy_time: %u compute_idle_time: %u\n",
		   kbdev->pm.backend.metrics.values.time_busy[2],
		   kbdev->pm.backend.metrics.values.time_idle[2]);
	seq_printf(file, "fragment_busy_time: %u fragment_idle_time: %u\n",
		   kbdev->pm.backend.metrics.values.time_busy[3],
		   kbdev->pm.backend.metrics.values.time_idle[3]);
#else
	seq_printf(file, "busy_time: %u idle_time: %u protm_time: %u\n",
