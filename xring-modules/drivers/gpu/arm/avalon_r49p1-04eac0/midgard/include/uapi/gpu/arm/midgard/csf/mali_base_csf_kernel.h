...
enum base_queue_group_throttle {
	BASE_QUEUE_GROUP_THROTTLE_NONE = 0,
	BASE_QUEUE_GROUP_THROTTLE_HIGH,
	BASE_QUEUE_GROUP_THROTTLE_MEDIUM,
	BASE_QUEUE_GROUP_THROTTLE_LOW,
	BASE_QUEUE_GROUP_THROTTLE_NO_BOOST,
	BASE_QUEUE_GROUP_THROTTLE_COUNT
};
