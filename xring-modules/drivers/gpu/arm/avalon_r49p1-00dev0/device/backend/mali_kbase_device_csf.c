...
#include <platform/xring/mali_kbase_xr_pm.h>
...
static const struct kbase_device_init dev_init[] = {
	...
	{ kbase_device_procfs_init, kbase_device_procfs_term, "ProcFS initialization failed" },
...
#if IS_ENABLED(CONFIG_MALI_XR_MEMREPAIR_ENABLE)
		kbase_xr_config_memory_repair(kbdev);
#endif
