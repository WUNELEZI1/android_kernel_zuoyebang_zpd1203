 ...
 * Caused by the frequency of FPGA is 10MHZ, thus, scale this time 10 times.
 */
...
struct kbase_mmu_mode {
	...
	void (*entry_set_ate_disarrange_bit)(u64 *entry, struct tagged_addr phy, unsigned long flags, int level);
#endif
...
/**
 * struct kbase_gpu_kmd_data - Collecting GPU KMD log error.
 *
 * @unhandled_page_fault:                The number of GPU page table errors.
 * @gpu_fault_worker:                    The number of GPU hardware errors.
 * @cs_fault:                            The number of common shader exceptions.
 * @soft_reset_gpu_fault:                The number of GPU soft reset failures.
 * @hard_reset_gpu_fault:                The number of GPU hard reset failures.
 * @as_active_bit_stuck:                 The number of GPU hardware power-up exceptions.
 * @unsuccessful_gpu_reset_detected:     The number of CSF queue termination failures.
 */
struct kbase_gpu_kmd_data {
	u32 total_error_num;
	u32 unhandled_page_fault;
	u32 gpu_fault_worker;
	u32 cs_fault;
	u32 soft_reset_gpu_fault;
	u32 hard_reset_gpu_fault;
	u32 as_active_bit_stuck;
	u32 unsuccessful_gpu_reset_detected;
};
...
struct kbase_device {
	...
	struct kbase_gpu_kmd_data gpu_kmd_data;
};
