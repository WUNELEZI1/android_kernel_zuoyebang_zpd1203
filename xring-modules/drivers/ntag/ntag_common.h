...
#define DTS_IRQ_GPIO_STR		"xring,ntag-irq"
...
#define WakeupRFOn_REG_EE		0x01CB  //Improve chip wake-up sensitivity
#define APC_REG_EE			0x01CF  //Increase chip transmit power in areas with low field strength
...
#define WakeupRFOn_REG_VAL		0x21
#define APC_REG_VAL			0x90
...
#define INIT_DELAY			5000 // ms

#define DTS_PINCTL_NTAG_DEFAULT          "ntag-default"
