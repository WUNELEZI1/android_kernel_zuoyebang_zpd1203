...
#define MAX_PLANENO  8			//identical to VB2_MAX_PLANES
#define MAX_INTRA_PIC_RATE 0x7fffffff
#define NO_RESPONSE_SEQID 0xFFFFFFFE
#define SEQID_UPLIMT 0x7FFFFFFE

#define VSI_DAEMON_FNAME    "xring_vpu_daemon"
#define VSI_DAEMON_PATH     "/usr/bin/xring_v4l2_server"
#define VSI_DAEMON_DEVMAJOR (320)
...
#define NOFEEDBACK_FLAG (1 << 7) //cause by suspend, no need to send ack msg
...
enum vsi_v4l2enc_pixel_fmt {
	...
	VSI_V4L2ENC_PIX_FMT_Y10L,
	VSI_V4L2ENC_PIX_FMT_Y10H,
	...
	VSI_V4L2ENC_PIX_FMT_RGBA1010102,
	VSI_V4L2ENC_PIX_FMT_ARGB2101010,
	VSI_V4L2ENC_PIX_FMT_ABGR2101010,
	VSI_V4L2ENC_PIX_FMT_BGRA1010102,
	VSI_V4L2ENC_PIX_FMT_P010,
	VSI_V4L2ENC_PIX_FMT_P010M,
...
#define BITDEPTH_24		5
#define BITDEPTH_32		6
...
enum vsi_v4l2dec_pixfmt {
	VSI_V4L2_DEC_PIX_FMT_NV12 = 0,
	VSI_V4L2_DEC_PIX_FMT_400,
	VSI_V4L2_DEC_PIX_FMT_Y10L,
	VSI_V4L2_DEC_PIX_FMT_Y10H,
	VSI_V4L2_DEC_PIX_FMT_411SP,
	VSI_V4L2_DEC_PIX_FMT_444SP,
	VSI_V4L2_DEC_PIX_FMT_YUV420,
	VSI_V4L2_DEC_PIX_FMT_YUV420M,
	VSI_V4L2_DEC_PIX_FMT_YUV422M,
	VSI_V4L2_DEC_PIX_FMT_YVU422M,
	VSI_V4L2_DEC_PIX_FMT_YUV444M,
	VSI_V4L2_DEC_PIX_FMT_YVU444M,
	VSI_V4L2_DEC_PIX_FMT_NV21,
	VSI_V4L2_DEC_PIX_FMT_YUYV,
	VSI_V4L2_DEC_PIX_FMT_422SP,
	VSI_V4L2_DEC_PIX_FMT_NV16M,
	VSI_V4L2_DEC_PIX_FMT_NV61,
	VSI_V4L2_DEC_PIX_FMT_NV61M,
	VSI_V4L2_DEC_PIX_FMT_YVU420,
	VSI_V4L2_DEC_PIX_FMT_YVU420M,
	VSI_V4L2_DEC_PIX_FMT_NV21M,
	VSI_V4L2_DEC_PIX_FMT_NV12M,
	VSI_V4L2_DEC_PIX_FMT_UYVY,
	VSI_V4L2_DEC_PIX_FMT_RGB565,
	VSI_V4L2_DEC_PIX_FMT_BGR565,
	VSI_V4L2_DEC_PIX_FMT_RGB555,
	VSI_V4L2_DEC_PIX_FMT_RGBA32,
	VSI_V4L2_DEC_PIX_FMT_BGR32,
	VSI_V4L2_DEC_PIX_FMT_ABGR32,
	VSI_V4L2_DEC_PIX_FMT_RGBX32,
	VSI_V4L2_DEC_PIX_FMT_ABGR555,
	VSI_V4L2_DEC_PIX_FMT_RGB444,
	VSI_V4L2_DEC_PIX_FMT_ABGR444,
	VSI_V4L2_DEC_PIX_FMT_XBGR444,
	VSI_V4L2_DEC_PIX_FMT_RGB32,
	VSI_V4L2_DEC_PIX_FMT_ARGB32,
	VSI_V4L2_DEC_PIX_FMT_XRGB32,
	VSI_V4L2_DEC_PIX_FMT_BGRA32,
	VSI_V4L2_DEC_PIX_FMT_XBGR32,
	VSI_V4L2_DEC_PIX_FMT_BGRX32,
	VSI_V4L2_DEC_PIX_FMT_RGBA1010102,
	VSI_V4L2_DEC_PIX_FMT_ARGB2101010,
	VSI_V4L2_DEC_PIX_FMT_ABGR2101010,
	VSI_V4L2_DEC_PIX_FMT_BGRA1010102,
	VSI_V4L2_DECOUT_DTRC,
	VSI_V4L2_DECOUT_P010,
	VSI_V4L2_DECOUT_P010M,
	VSI_V4L2_DECOUT_NV12_10BIT,
	VSI_V4L2_DECOUT_DTRC_10BIT,
	VSI_V4L2_DECOUT_RFC,
	VSI_V4L2_DECOUT_RFC_10BIT,
	VSI_V4L2_DEC_PIX_FMT_NV12_4L4,
	VSI_V4L2_DEC_PIX_FMT_P010_4L4,
	VSI_V4L2_DEC_PIX_FMT_MAX,
};
...
struct vsi_v4l2_dev_info {
	...
	s32 max_gdrDuration;
	u32 map_headerMode;
	u32 map_scaledOutput;	//encoder prp scaled output support formats
	u32 outputRateNumer;
	u32 outputRateDenom;
	u32 inputRateNumer;
	u32 inputRateDenom;
	...
	u8 dec_has_pix_fmt[VSI_V4L2_DEC_PIX_FMT_MAX];
	/**********************  dec hw info end **********************/
};

struct daemon_timer_node {
...
#define VSI_IOCTL_CMD_INITDEV          _IOW(VSIV4L2_IOCTL_BASE, 0x45, struct vsi_v4l2_dev_info)
#define VSI_IOCTL_CMD_DMA_BUFFER_INFO  _IOW(VSIV4L2_IOCTL_BASE, 0x46, struct vsi_v4l2_dma_buffers_info)
#define VSI_IOCTL_CMD_START_TIMER      _IOW(VSIV4L2_IOCTL_BASE, 0x47, struct timer_cfg)
#define VSI_IOCTL_CMD_DEL_TIMER        _IOW(VSIV4L2_IOCTL_BASE, 0x48, struct timer_cfg)
#define VSI_IOCTL_CMD_DESTROY_TIMER    _IOW(VSIV4L2_IOCTL_BASE, 0x49, struct timer_cfg)
...
struct v4l2_daemon_meta_params {
	dma_addr_t busMetaBuf;
	u32	metabufsize;
};
...
struct v4l2_daemon_enc_buffers {
	...
	struct v4l2_daemon_meta_params metabufinfo;
...
struct v4l2_enccfg_sliceencoding {
	ulong head;
	s32 ctu_rows;
};
...
#define MAX_ENC_PARAM_SIZE	\
	...
	+ sizeof(struct v4l2_enccfg_sliceencoding)
...
struct v4l2_daemon_dec_framerate_params {
	ulong head;
	s32 output_rate_numer;
	s32 output_rate_denom;
	s32 input_rate_numer;
	s32 input_rate_denom;
};
...
//infer output
	dma_addr_t busOutBuf[MAX_PLANENO];	//for Y or YUV
	s32    OutBufSize[MAX_PLANENO];
	s32 outBufFormat;
	s32 output_width;
	s32 output_height;
	s32 output_wstride;
	...
	struct v4l2_daemon_meta_params metabufinfo;
	u32 bytesused[MAX_PLANENO];	//valid bytes in buffer from user app.
	u64 timestamp;
	...
	struct v4l2_daemon_dec_framerate_params framerate_info;
};
