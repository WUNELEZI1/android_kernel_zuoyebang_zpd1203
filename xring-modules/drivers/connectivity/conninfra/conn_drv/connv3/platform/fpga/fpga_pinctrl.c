...
********************************************************************************
*/
int connv3_plt_pinctrl_init_fpga(struct platform_device *pdev);
int connv3_plt_pinctrl_deinit_fpga(void);
int connv3_plt_pinctrl_setup_pre_fpga(void);
int connv3_plt_pinctrl_setup_done_fpga(void);
int connv3_plt_pinctrl_remove_fpga(void);
int connv3_plt_pinctrl_ext_32k_ctrl(bool on);

const struct connv3_platform_pinctrl_ops g_connv3_platform_pinctrl_ops_fpga = {
	.pinctrl_init = connv3_plt_pinctrl_init_fpga,
	.pinctrl_deinit = connv3_plt_pinctrl_deinit_fpga,
	.pinctrl_setup_pre = connv3_plt_pinctrl_setup_pre_fpga,
	.pinctrl_setup_done = connv3_plt_pinctrl_setup_done_fpga,
	.pinctrl_remove = connv3_plt_pinctrl_remove_fpga,
...
static void __attribute__((__unused__)) _dump_uart_gpio_state(char* tag)
{
#if 1
#else
