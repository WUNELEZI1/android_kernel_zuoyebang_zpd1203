...
int connv3_pinctrl_mng_fmd_setting(u32 enable) {
	int ret = 0;

	if (g_connv3_platform_pinctrl_ops &&
		g_connv3_platform_pinctrl_ops->pinctrl_fmd_setting)
		ret = g_connv3_platform_pinctrl_ops->pinctrl_fmd_setting(enable);
