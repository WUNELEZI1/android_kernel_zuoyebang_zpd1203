...
#define WAKE_LOCK_TX_TIMEOUT                            500	/* ms */
#define WAKE_LOCK_OOB_TIMEOUT                           50	/* ms */
#define PM_SR_TIMEOUT                                   3000	/* ms */
#endif
...
#if IS_ENABLED(CFG_EAP_PCIE_L2_FLOW)
	struct completion rSRComp;	/* Pending completion for SR */
#endif
#if CFG_SUPPORT_MULTITHREAD
...
#if IS_ENABLED(CFG_EAP_PCIE_L2_FLOW)
	struct semaphore rDrvOwnSem; /* driver own semaphore */
#endif
};
