...
#define GLUE_FLAG_HIF_TX_PROCESS \
	(GLUE_FLAG_HIF_TX_CMD | GLUE_FLAG_HIF_TX | \
	GLUE_FLAG_MGMT_DIRECT_HIF_TX)
#endif
#define HIF_FLAG \
	(HIF_FLAG_AER_RESET)
...
*/
#define kalPrint(_Fmt...)               kalPrintSALog(WLAN_TAG _Fmt)
#define kalPrintLimited(_Fmt...)        kalPrintSALogLimited(WLAN_TAG _Fmt)
#else
