...
{
	struct list_head *ent = NULL, *n = NULL;
...
{
	/* Memory barriers are inserted before atomic
	 * operations to ensure that all memory operations
	 * are completed before atomic operations are performed
	 */
	smp_mb__before_atomic();
	atomic_inc(&f->refcnt);
	/* Memory barriers are inserted after atomic
	 * operations to ensure that all memory operations
	 * are completed before atomic operations are performed
	 */
