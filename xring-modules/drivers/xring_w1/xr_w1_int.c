...
{
	struct w1_master *dev = NULL, *entry = NULL;
	int retval = 0;
...
#ifdef W1_TH_CLEANUP /* Thread cleanup code, not required currently. */
err_out_kill_thread:
...
{
	struct w1_netlink_msg msg;
	struct w1_slave *sl = NULL, *sln = NULL;
...
{
	struct w1_master *dev = NULL, *found = NULL;
