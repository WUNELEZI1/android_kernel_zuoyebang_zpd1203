...
#ifdef CONFIG_XRING_DSU_PMU_EVENT_COUNTER_64BITS
/* All counters are 64bit */
#define DSU_PMU_COUNTER_WIDTH(idx)	64
#else
...
#ifdef CONFIG_XRING_DSU_PMU_CYCLE_COUNTER
...
{
	u64 val = DSU_PMU_COUNTER_MASK(event->hw.idx) >> 1;
