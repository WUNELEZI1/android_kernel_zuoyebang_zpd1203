...
int cs35l45_i2c_probe(struct i2c_client *client,
			     const struct i2c_device_id *id)
{
	...
	if (cs35l45 == NULL) {
		dev_err(dev, "Failed to mem for devm_kazlloc for cs35l45\n");
		return -ENOMEM;
	}
...
EXPORT_SYMBOL_GPL(cs35l45_i2c_probe);
int cs35l45_i2c_remove(struct i2c_client *client)
{
	struct cs35l45_private *cs35l45 = i2c_get_clientdata(client);
	return cs35l45_remove(cs35l45);
}
EXPORT_SYMBOL_GPL(cs35l45_i2c_remove);
/*
