...
int madera_i2c_init(struct i2c_client *i2c,
...
EXPORT_SYMBOL_GPL(madera_i2c_init);
...
EXPORT_SYMBOL_GPL(madera_i2c_deinit);
...
MODULE_DESCRIPTION("X-Ring Madera I2C bus interface");
