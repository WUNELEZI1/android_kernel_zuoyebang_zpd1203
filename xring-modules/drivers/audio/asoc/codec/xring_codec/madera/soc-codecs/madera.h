...
//#define CODEC_I2S_DEBUG
#define USE_FLL_CLOCK
...
struct in_unmute_work {
	struct madera_priv *priv;
	int decimator;
	struct delayed_work dwork;
};

#define MADERA_NUM_DECIMATORS 8
...
struct madera_priv {
	...
	struct in_unmute_work in_unmute_work[MADERA_NUM_DECIMATORS];
};
