...
/**************************debug******************************/
#define DEBUG
#define FP_REGULATOR_PWM_CONTROL
...
#include "../../../xring-modules/include/soc/xring/xr_pmic.h"
...
#include <../../../xring-modules/include/soc/xring/display/panel_event_notifier.h>
#endif
...
/* fp sensor has change to sleep mode while screen off */#define FP_IOC_MAGIC	         'g'
#define FP_IOC_INIT			     _IOR(FP_IOC_MAGIC, 0, u8)
#define FP_IOC_EXIT			     _IO(FP_IOC_MAGIC, 1)
#define FP_IOC_RESET			 _IO(FP_IOC_MAGIC, 2)
...
#define FP_IOC_WAKEUP_SYSTEM	     _IOW(FP_IOC_MAGIC, 29, uint32_t)
...
#define FP_IOC_INTR2_OPERATION       _IOW(FP_IOC_MAGIC, 36, char)
...
/**************************Pin******************************/
	...
	struct pinctrl_state *pins_ls_low;
	struct pinctrl_state *pins_irq_low;
/**************************Pin******************************/
...
/**************************CONFIG_REGULATOR_PWM******************************/
	...
	struct regulator *extension_regulator1;
	struct regulator *extension_regulator2;
	struct regulator *extension_regulator3;
#endif
/**************************CONFIG_REGULATOR_PWM******************************/
};
