...
#define CONFIG_SUBPMIC_6601
#define SUBPMIC_STATUS_PLUGIN		0x0001

enum sc6601_subpmic_event_type {
	SC6601_SUBPMIC_EVENT_BC12 = 0,
	SC6601_SUBPMIC_EVENT_BUCK_ALERT,
	SC6601_SUBPMIC_EVENT_HK_ALERT,
	SC6601_SUBPMIC_EVENT_DPDM_ALERT,
};

enum sc6601_subpmic_get_cp_mode_event_type {
	SC6601_SUBPMIC_EVENT_CP_MODE = 6,
	SC6601_SUBPMIC_EVENT_BTB_CHANGE,
};
...
int subpmic_dev_notify(int event, bool false);
#endif
