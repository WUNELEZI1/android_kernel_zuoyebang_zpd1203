...
static int __sc96281_read_block(struct sc96281 *sc, uint16_t reg, uint16_t length, uint8_t *data)
{
    int ret;
...
static int __sc96281_write_block(struct sc96281 *sc, uint16_t reg, uint16_t length, uint8_t *data)
{
    int ret;
...
static int sc96281_read_block(struct sc96281 *sc, uint16_t reg, uint8_t *data, uint16_t len)
{
    int ret;
...
static int sc96281_write_block(struct sc96281 *sc, uint16_t reg, uint8_t *data, uint16_t len)
{
    int ret;
...
static int SC96281_read_register(struct sc96281 *sc, uint16_t reg, uint8_t *data, uint8_t len)
{
    int ret;
    uint8_t r_data[4] = {0};
    uint8_t i;
...
static int sc96281_write_register(struct sc96281 *sc, uint16_t reg, uint8_t *data, uint8_t len)
{
    int ret;
    uint8_t r_data[4] = {0};
    uint8_t i;
...
__maybe_unused static int pgm_sector_erase(struct sc96281 *sc, uint32_t addr, uint16_t length) {
    uint8_t state = 0;
    pgmPktType pgm = {0};
    uint16_t sram_addr_h = SRAM_BASE >> 16;
    uint16_t sram_addr_l = SRAM_BASE & 0xFFFF;
...
__maybe_unused static int pgm_access(struct sc96281 *sc, uint8_t * key_buffer, uint8_t key_len) {
    uint8_t state = 0;
    pgmPktType pgm = {0};
    uint16_t sram_addr_h = SRAM_BASE >> 16;
    uint16_t sram_addr_l = SRAM_BASE & 0xFFFF;
...
__maybe_unused static int pgm_read_crc(struct sc96281 *sc, uint8_t * crc, uint16_t crc_size, uint16_t addr, uint16_t len) {
...
__maybe_unused static int pgm_read(struct sc96281 *sc, uint32_t addr, uint8_t *buffer, uint16_t len,uint8_t sel) {
    uint16_t i;
    uint8_t state = 0;
    pgmPktType pgm = {0};
    uint16_t offset;
...
__maybe_unused static int pgm_write(struct sc96281 *sc, uint32_t addr, uint8_t *buffer, uint16_t len, uint8_t sel) {
    uint16_t i;
    uint8_t state = 0;
    pgmPktType pgm = {0};
    uint16_t offset;
...
static int sc96281_read_bin(struct sc96281 *sc, char *firmware_buf, uint32_t *firmware_len)
{
    char *buf = NULL;
    int size = 0;
...
static int crc_check(struct sc96281 *sc, uint8_t margin, uint8_t *buf, uint32_t len)
{
    int i, ret;
    uint32_t data32 = 0;
    uint32_t read_crc = 0;
