...
#ifndef MCA_LOG_TAG
#define MCA_LOG_TAG "sc6601a_evt_com"
#endif
	...
	struct pd_port *pd_port, struct pd_event *pd_event)
{
	...
	if (pd_port->pe_data.renegotiation_count > PD_HARD_RESET_COUNT) {
		mca_log_info("renegotiation failed\n");
