...
#ifndef MCA_LOG_TAG
#define MCA_LOG_TAG "sc6601a_tcpci_timer"
#endif
...
int tcpci_timer_init(struct tcpc_device *tcpc)
{
    ...
    mca_log_info("PD Timer number = %d\n", PD_TIMER_NR);
