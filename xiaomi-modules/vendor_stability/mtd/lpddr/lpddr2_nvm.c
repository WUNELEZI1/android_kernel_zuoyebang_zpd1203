...
/*
 * LPDDR2-NVM MI_MTD driver. This module provides read, write, erase, lock/unlock
...
static int lpddr2_nvm_probe(struct platform_device *pdev)
{
	...
	*mtd = lpddr2_nvm_mtd_info;
	...
	/* Parse partitions and register the MI_MTD device */
...
MODULE_DESCRIPTION("MI_MTD driver for LPDDR2-NVM PCM memories");
