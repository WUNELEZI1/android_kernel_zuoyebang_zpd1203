 ...
 *                     integrity error reported by the MI_MTD driver
 *                     (uncorrectable ECC error in case of NAND)
 * UBI_IO_BAD_HDR: the EC or VID header is corrupted (bad magic or CRC)
 * UBI_IO_BAD_HDR_EBADMSG: the same as %UBI_IO_BAD_HDR, but also there was a
 *                         data integrity error reported by the MI_MTD driver
 *                         (uncorrectable ECC error in case of NAND)
 ...
 *
 * @flash_size: underlying MI_MTD device size (in bytes)
 * @peb_count: count of physical eraseblocks on the MI_MTD device
 ...
 * @min_io_size: minimal input/output unit size of the underlying MI_MTD device
 ...
 * @bad_allowed: whether the MI_MTD device admits bad physical eraseblocks or not
 * @nor_flash: non-zero if working on top of NOR flash
 * @max_write_size: maximum amount of bytes the underlying flash can write at a
 *                  time (MI_MTD write buffer size)
 * @mtd: MI_MTD device descriptor
 *
 ...
 * attaching an MI_MTD device. Note, if this PEB does not belong to any LEB /
 ...
 *
 * One object of this type is allocated for each volume when attaching an MI_MTD
 * device.
 */
...
/**
 * struct ubi_attach_info - MI_MTD device attaching information.
 ...
 * @is_empty: flag indicating whether the MI_MTD device is empty or not
 ...
 *
 * This data structure contains the result of attaching an MI_MTD device and may
