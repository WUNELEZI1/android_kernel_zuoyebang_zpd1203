 ...
 * returned for any volume type if an ECC error was detected by the MI_MTD device
 ...
 * mode, simply because we do not know what happened at the MI_MTD level, and we
 ...
 * with a warning every time they attach the MI_MTD device. This was an issue
