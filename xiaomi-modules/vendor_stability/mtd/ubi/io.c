 ...
 * underlying MI_MTD devices. It also implements handy functions for reading and
 * writing UBI headers.
 *
 ...
 * in case of NAND flash it is a NAND page, etc. This is reported by MI_MTD in the
 ...
 *
 * A: because when writing a sub-page, MI_MTD still writes a full 2K page but the
 ...
 * o %-EBADMSG if the MI_MTD subsystem reported about data integrity problems, for
		       ...
		       struct ubi_ec_hdr *ec_hdr, int verbose)
{
	...
	if (read_err) {
		 ...
		 * occurred, or MI_MTD reported a data integrity error
