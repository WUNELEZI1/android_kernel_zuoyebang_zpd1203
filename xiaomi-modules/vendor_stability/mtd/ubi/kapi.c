 ...
 * o for both static and dynamic volumes if MI_MTD driver has detected a data
 ...
 * un-mapped again when this MI_MTD device is attached. They may actually be
 ...
 * eraseblock when the MI_MTD device is attached again.
 *
 ...
 *
 * The underlying MI_MTD device may cache data in hardware or in software. This
