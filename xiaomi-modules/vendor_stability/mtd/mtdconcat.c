...
/*
 * MI_MTD device concatenation layer
 *
...
/*
 * Given a pointer to the MI_MTD object in the mtd_concat structure,
 * we can retrieve the pointer to that structure with this macro.
 */
#define CONCAT(x)  ((struct mtd_concat *)(x))

/*
 * MI_MTD methods which look up the relevant subdevice, translate the
...
/*
 * This function constructs a virtual MI_MTD device by concatenating
 * num_devs MI_MTD devices. A pointer to the new device object is
...
{				/* name for the new device   */
	...
	printk(KERN_NOTICE "Concatenating MI_MTD devices:\n");
	...
	/*
	 * Set up the new "super" device's MI_MTD object structure, check for
...
MODULE_DESCRIPTION("Generic support for concatenating of MI_MTD devices");
