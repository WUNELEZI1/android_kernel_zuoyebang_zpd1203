 ...
 *	implements this PCI Ram device as an MI_MTD (Memory Technology
 ...
 *
 *	Most of the MI_MTD code for this driver was originally written
 *	for the slram.o module in the MI_MTD drivers package which
 *	allows the mapping of system memory into an MI_MTD device.
