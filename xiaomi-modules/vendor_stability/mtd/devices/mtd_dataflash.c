...
/*
 * Atmel AT45xxx DataFlash MI_MTD driver for lightweight SPI framework
 *
...
/*
 * Register DataFlash device with MI_MTD subsystem.
 */
...
MODULE_DESCRIPTION("MI_MTD DataFlash driver");
