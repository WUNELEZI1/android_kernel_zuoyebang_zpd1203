...
/*
 * OPAL PNOR flash MI_MTD abstraction
 *
 * Copyright IBM 2015
 */
...
/*
 * This driver creates the a Linux MI_MTD abstraction for platform PNOR flash
...
/*
 * Don't return -ERESTARTSYS if we can't get a token, the MI_MTD core
		...
		loff_t offset, size_t len, size_t *retlen, u_char *buf)
{
	...
	if (rc == OPAL_ASYNC_COMPLETION) {
		...
		if (rc) {
			 ...
			 * done. However, because the MI_MTD core sends
...
MODULE_DESCRIPTION("MI_MTD abstraction for OPAL flash");
