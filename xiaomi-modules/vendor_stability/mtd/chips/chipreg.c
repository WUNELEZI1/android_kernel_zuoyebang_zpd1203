...
/*
 * Destroy an MI_MTD device which was created for a map device.
 * Make sure the MI_MTD device is already unregistered before calling this
 */
...
MODULE_DESCRIPTION("Core routines for registering and invoking MI_MTD chip drivers");
