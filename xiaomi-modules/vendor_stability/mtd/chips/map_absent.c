 ...
 *
 * This map driver is used to allocate "placeholder" MI_MTD
 * devices on systems that have socketed/removable media.
 * Use of this driver as a fallback preserves the expected
 * registration of MI_MTD device nodes regardless of probe outcome.
...
MODULE_DESCRIPTION("Placeholder MI_MTD chip driver for 'absent' chips");
