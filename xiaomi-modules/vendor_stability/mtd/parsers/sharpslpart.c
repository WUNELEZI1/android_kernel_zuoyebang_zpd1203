/*
 * sharpslpart.c - MI_MTD partition parser for NAND flash using the SHARP FTL
...
MODULE_DESCRIPTION("MI_MTD partitioning for NAND flash on Sharp SL Series");
