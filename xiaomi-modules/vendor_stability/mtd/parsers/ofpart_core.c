...
MODULE_LICENSE("GPL");
MODULE_DESCRIPTION("Parser for MI_MTD partitioning information in device tree");
MODULE_AUTHOR("Vitaly Wool, David Gibson");
/*
 * When MI_MTD core cannot find the requested parser, it tries to load the module
