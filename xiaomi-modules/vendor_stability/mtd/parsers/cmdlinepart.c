 ...
 *
 * The parts are assigned MI_MTD numbers in the order they are specified in the
...
/*
 * Parse one partition definition for an MI_MTD. Since there can be many
				      ...
				      int extra_mem_size)
{
	...
	/* if lk is found do NOT unlock the MI_MTD partition*/
	if (strncmp(s, "lk", 2) == 0) {
...
static int mtdpart_setup_real(char *s)
{
	...
	for( ; s != NULL; )
	{
		 ...
		 * be present in the MI_MTD name, only the last one is interpreted
...
/*
 * Main function to be called from the MI_MTD mapping driver/device to
...
MODULE_DESCRIPTION("Command line configuration of MI_MTD partitions");
