...
/**
 * onenand_read_oob_nolock - [MI_MTD Interface] OneNAND read out-of-band
 * @mtd:		MI_MTD device structure
 * @from:		offset to read from
 * @ops:		oob operation description structure
 *
...
/**
 * onenand_read_oob - [MI_MTD Interface] Read main and/or out-of-band
 * @mtd:		MI_MTD device structure
 * @from:		offset to read from
 * @ops:		oob operation description structure
 *
...
/**
 * onenand_bbt_read_oob - [MI_MTD Interface] OneNAND read out-of-band for bbt scan
 * @mtd:		MI_MTD device structure
 * @from:		offset to read from
 * @ops:		oob operation description structure
 *
...
/**
 * onenand_panic_write - [MI_MTD Interface] write buffer to FLASH in a panic context
 * @mtd:		MI_MTD device structure
...
/**
 * onenand_write_oob - [MI_MTD Interface] NAND write data and/or out-of-band
 * @mtd:		MI_MTD device structure
 * @to:			offset to write
 * @ops:		oob operation description structure
 */
					...
					unsigned int block_size)
{
	...
	while (len) {
		...
		if (region && addr == region_end) {
			...
			if (len & (block_size - 1)) {
				/* FIXME: This should be handled at MI_MTD partitioning level. */
...
/**
 * onenand_erase - [MI_MTD Interface] erase block(s)
 * @mtd:		MI_MTD device structure
 * @instr:		erase instruction
 *
...
/**
 * onenand_sync - [MI_MTD Interface] sync
 * @mtd:		MI_MTD device structure
 *
...
/**
 * onenand_block_isbad - [MI_MTD Interface] Check whether the block at the given offset is bad
 * @mtd:		MI_MTD device structure
...
/**
 * onenand_block_markbad - [MI_MTD Interface] Mark the block at the given offset as bad
 * @mtd:		MI_MTD device structure
 * @ofs:		offset relative to mtd start
 *
...
/**
 * onenand_lock - [MI_MTD Interface] Lock block(s)
 * @mtd:		MI_MTD device structure
 * @ofs:		offset relative to mtd start
...
/**
 * onenand_unlock - [MI_MTD Interface] Unlock block(s)
 * @mtd:		MI_MTD device structure
 * @ofs:		offset relative to mtd start
 * @len:		number of bytes to unlock
 *
...
/**
 * onenand_get_fact_prot_info - [MI_MTD Interface] Read factory OTP info
 * @mtd:		MI_MTD device structure
 * @len:		number of bytes to read
 * @retlen:	pointer to variable to store the number of read bytes
 * @buf:		the databuffer to put/get data
...
/**
 * onenand_read_fact_prot_reg - [MI_MTD Interface] Read factory OTP area
 * @mtd:		MI_MTD device structure
 * @from:		The offset to read
 * @len:		number of bytes to read
 * @retlen:	pointer to variable to store the number of read bytes
...
/**
 * onenand_get_user_prot_info - [MI_MTD Interface] Read user OTP info
 * @mtd:		MI_MTD device structure
 * @retlen:	pointer to variable to store the number of read bytes
 * @len:		number of bytes to read
 * @buf:		the databuffer to put/get data
...
/**
 * onenand_read_user_prot_reg - [MI_MTD Interface] Read user OTP area
 * @mtd:		MI_MTD device structure
 * @from:		The offset to read
 * @len:		number of bytes to read
 * @retlen:	pointer to variable to store the number of read bytes
...
/**
 * onenand_write_user_prot_reg - [MI_MTD Interface] Write user OTP area
 * @mtd:		MI_MTD device structure
...
/**
 * onenand_lock_user_prot_reg - [MI_MTD Interface] Lock user OTP area
 * @mtd:		MI_MTD device structure
 * @from:		The offset to lock
 * @len:		number of bytes to unlock
 *
...
/**
 * onenand_suspend - [MI_MTD Interface] Suspend the OneNAND flash
 * @mtd:		MI_MTD device structure
 */
...
/**
 * onenand_resume - [MI_MTD Interface] Resume the OneNAND flash
 * @mtd:		MI_MTD device structure
 */
...
int onenand_scan(struct mtd_info *mtd, int maxchips)
{
	...
	/* Fill in remaining MI_MTD driver data */
