...
/*
 *  Overview:
 *   This is the generic MI_MTD driver for NAND flash devices. It should be
...
/**
 * nand_do_write_oob - [MI_MTD Interface] NAND write out-of-band
 * @chip: NAND chip object
...
/**
 * nand_read_oob - [MI_MTD Interface] NAND read data and/or out-of-band
 * @mtd: MI_MTD device structure
 * @from: offset to read from
 * @ops: oob operation description structure
 *
...
/**
 * panic_nand_write - [MI_MTD Interface] NAND write with ECC
 * @mtd: MI_MTD device structure
 * @to: offset to write to
...
/**
 * nand_write_oob - [MI_MTD Interface] NAND write data and/or out-of-band
 * @mtd: MI_MTD device structure
 * @to: offset to write to
 * @ops: oob operation description structure
 */
...
/**
 * nand_erase - [MI_MTD Interface] erase block(s)
 * @mtd: MI_MTD device structure
...
/**
 * nand_sync - [MI_MTD Interface] sync
 * @mtd: MI_MTD device structure
 *
...
/**
 * nand_block_isbad - [MI_MTD Interface] Check if block at offset is bad
 * @mtd: MI_MTD device structure
...
/**
 * nand_block_markbad - [MI_MTD Interface] Mark block at the given offset as bad
 * @mtd: MI_MTD device structure
...
/**
 * nand_suspend - [MI_MTD Interface] Suspend the NAND flash
 * @mtd: MI_MTD device structure
 *
 * Returns 0 for success or negative error code otherwise.
 */
...
/**
 * nand_resume - [MI_MTD Interface] Resume the NAND flash
 * @mtd: MI_MTD device structure
 */
...
/**
 * nand_shutdown - [MI_MTD Interface] Finish the current NAND operation and
...
/**
 * nand_lock - [MI_MTD Interface] Lock the NAND flash
 * @mtd: MI_MTD device structure
...
/**
 * nand_unlock - [MI_MTD Interface] Unlock the NAND flash
 * @mtd: MI_MTD device structure
 * @ofs: offset byte address
 ...
 * decodes a matching ID table entry and assigns the MI_MTD size parameters for
 * the chip.
 */
 ...
 * flash ID and sets up MI_MTD fields accordingly.
 *
