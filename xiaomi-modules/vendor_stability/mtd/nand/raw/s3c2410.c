...
/**
 * struct s3c2410_nand_mtd - driver MI_MTD structure
 * @mtd: The MI_MTD instance to pass to the MI_MTD layer.
 ...
 * @mtds: An array of MI_MTD instances on this controller.
 ...
 *
 * This is called by the MI_MTD layer to either select a given chip for the
 ...
 * @nmtd: The new controller MI_MTD instance to fill in.
 * @set: The information passed from the board specific platform data.
 *
 * Initialise the given @nmtd from the information in @info and @set. This
 * readies the structure for use with the MI_MTD layer functions by ensuring
...
MODULE_DESCRIPTION("S3C24XX MI_MTD NAND driver");
