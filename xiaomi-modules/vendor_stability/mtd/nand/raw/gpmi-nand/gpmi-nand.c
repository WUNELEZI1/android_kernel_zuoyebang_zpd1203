 ...
 * easy. When reading a page, for example, the NAND Flash MI_MTD code calls our
 * ecc.read_page or ecc.read_page_raw function. Thus, the fact that MI_MTD wants an
...
static int gpmi_nand_init(struct gpmi_nand_data *this)
{
	...
	/* init the MI_MTD data structures */
	mtd->name		= "gpmi-nand";
