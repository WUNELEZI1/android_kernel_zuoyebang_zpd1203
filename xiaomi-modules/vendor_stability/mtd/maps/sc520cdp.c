...
/* sc520cdp.c -- MI_MTD map driver for AMD SC520 Customer Development Platform
 *
...
static int __init init_sc520cdp(void)
{
	...
	if(devices_found >= 2) {
		/* Combine the two flash banks into a single MI_MTD device & register it: */
...
MODULE_DESCRIPTION("MI_MTD map driver for AMD SC520 Customer Development Platform");
