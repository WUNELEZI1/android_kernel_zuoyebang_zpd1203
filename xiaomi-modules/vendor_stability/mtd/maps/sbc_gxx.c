...
/* sbc_gxx.c -- MI_MTD map driver for Arcom Control Systems SBC-MediaGX,
...
/* MI_MTD device for all of the flash. */
...
static int __init init_sbc_gxx(void)
{
	...
	/* Create MI_MTD devices for each partition. */
...
MODULE_DESCRIPTION("MI_MTD map driver for SBC-GXm and SBC-GX1 series boards");
