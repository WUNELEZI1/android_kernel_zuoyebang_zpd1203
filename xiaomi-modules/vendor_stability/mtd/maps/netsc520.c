...
/* netsc520.c -- MI_MTD map driver for AMD NetSc520 Demonstration Board
 *
...
** MI_MTD character routines.  The second and fourth partitions should
...
MODULE_DESCRIPTION("MI_MTD map driver for AMD NetSc520 Demonstration Board");
