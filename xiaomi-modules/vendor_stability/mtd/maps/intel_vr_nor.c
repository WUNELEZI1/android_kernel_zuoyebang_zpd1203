 ...
 *
 * An MI_MTD map driver for a NOR flash bank on the Expansion Bus of the Intel
...
MODULE_DESCRIPTION("MI_MTD map driver for NOR flash on Intel Vermilion Range");
MODULE_LICENSE("GPL");
