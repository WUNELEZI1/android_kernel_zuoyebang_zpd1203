...
/*
 * Direct MI_MTD block device access
 *
...
static int mtdblock_open(struct mtd_blktrans_dev *mbd)
{
	...
	if (mtd_type_is_nand(mbd->mtd))
		pr_warn_ratelimited("%s: MI_MTD device '%s' is NAND, please consider using UBI block devices instead.\n",
...
MODULE_DESCRIPTION("Caching read/erase/writeback block device emulation access to MI_MTD devices");
