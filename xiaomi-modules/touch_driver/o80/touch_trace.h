...
TRACE_EVENT(tracing_mark_write,
	...
	TP_printk("%c|%d|Read Thp Frame (frm_cnt:%llu, icframe_cnt:%d)", __entry->trace_type,
...
#define TRACE_INCLUDE_PATH ../../../../vendor/xring/android-kernel/xiaomi-modules/touch_driver/o80/
