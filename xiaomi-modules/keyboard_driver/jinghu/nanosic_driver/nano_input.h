...
/**
 * unit_exponent                   | code
 * [0 1 ... 7 -8 -7 ... -2 ... -1] | 0x0~0xF
 */
#define UNIT_EXPONENT(x)  ((x) >= 0 ? (x) : ((x) + 0x10))

/**
 *                         (logical_maximum - logical_minimum)
 * resolution = ----------------------------------------------------------
 *              (physical_maximum - physical_minimum) * 10 ^ unit_exponent
 * unit: px/mm = px/(cm * 10 ^ -1)
 */
// Unit Exponent
#define DEFAULT_EXPONENT -1

// px
#define TOUCH_PAD_X_SIZE_DESC 3683
#define TOUCH_PAD_Y_SIZE_DESC 2175
// mm
#define MI_DISPLAY_X_SIZE_DESC 110
#define MI_DISPLAY_Y_SIZE_DESC 59
// pressure
#define TOUCH_PAD_PRESSURE_SIZE_DESC 65535
...
static unsigned char HID_TouchReportDescriptor[] =
    {
        ...
        0x26, (TOUCH_PAD_PRESSURE_SIZE_DESC & 0xff), ((TOUCH_PAD_PRESSURE_SIZE_DESC >> 8) & 0xff),   //     Logical Maximum
        0x75, 0x10,                                                                    //     Report Size (16)
        ...
        0x75, 0x10,                                                                    //     Report Size (16)
        0x55, UNIT_EXPONENT(DEFAULT_EXPONENT),                                         //     Unit Exponent(-3)
        0x65, UNIT_CM,                                                                 //     Unit(mm,Englinear)
        0x09, 0x30,                                                                    //     Usage (X)
        0x35, 0x00,                                                                    //     Physical Minimum (0)
