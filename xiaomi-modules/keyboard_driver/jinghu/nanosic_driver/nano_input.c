 ...
 *
 ** */
static int Nanosic_input_raw_request(struct hid_device *hdev, unsigned char reportnum,
 ...
 *
 ** */
static int Nanosic_input_set_report(struct hid_device *hid, __u8 *buf, size_t size)
{
